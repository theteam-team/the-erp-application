...
-- Schema phyzia3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `phyzia3` DEFAULT CHARACTER SET utf8 ;
USE `phyzia3` ;

-- -----------------------------------------------------
-- Table `phyzia3`.`Employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Employee` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Customer` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Opportunities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Opportunities` (
  ...
  CONSTRAINT `fk_opportunities_Customer1`
    ...
    REFERENCES `phyzia3`.`Customer` (`Customer_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunities_Employee1`
    FOREIGN KEY (`Employee_Employee_ID`)
    REFERENCES `phyzia3`.`Employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Customer_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Customer_Address` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Supplier` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Product` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Shipment` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Payment` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Category` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Product_has_Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Product_has_Supplier` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Product_has_Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Product_has_Category` (
  `Product_Product_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Product_has_Category1_Category1`
    ...
    REFERENCES `phyzia3`.`Category` (`Category_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Account` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Interest` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Customer_Interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Customer_Interest` (
  `Level` INT NULL,
  `Customer_Customer_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Customer_Interest_Interest1`
    ...
    REFERENCES `phyzia3`.`Interest` (`Interest_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Opportunity_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Opportunity_Product` (
  ...
  CONSTRAINT `fk_Opportunity_Product_Opportunities1`
    ...
    REFERENCES `phyzia3`.`Opportunities` (`Opportunity_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`order_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`order_table` (
  ...
  CONSTRAINT `fk_Order_Payment1`
    ...
    REFERENCES `phyzia3`.`Payment` (`Payment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Order_Shipment1`
    ...
    REFERENCES `phyzia3`.`Shipment` (`Shipment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Order_has_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Order_has_Product` (
  ...
  CONSTRAINT `fk_Order_has_Product1_Order1`
    ...
    REFERENCES `phyzia3`.`order_table` (`Order_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Inventory` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Inventory_has_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Inventory_has_Product` (
  ...
  CONSTRAINT `fk_Inventory_has_Product_Inventory1`
    ...
    REFERENCES `phyzia3`.`Inventory` (`Inventory_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Employee_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Employee_Address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Supplier_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Supplier_Address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`BillMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`BillMaterials` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Inventory_has_BillMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Inventory_has_BillMaterials` (
  `Inventory_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
  `position` VARCHAR(45) NULL,
  `Units_In_Inventory` INT NULL,
  ...
  CONSTRAINT `fk_Inventory_has_BillMaterials_BillMaterials`
    ...
    REFERENCES `phyzia3`.`BillMaterials` (`BillMaterials_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `phyzia3`.`Product_has_BillMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`Product_has_BillMaterials` (
  `Product_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `phyzia3`.`ManufacturingOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`ManufacturingOrder` (
...
-- -----------------------------------------------------
-- Table `phyzia3`.`ManufacturingOrder_has_Materials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `phyzia3`.`ManufacturingOrder_has_Materials` (
  `ManufacturingOrder_ID` VARCHAR(45) NOT NULL,
  `Product_ID` VARCHAR(45) NOT NULL,
  `Units_In_order` INT NULL,
  `Units_Done` INT NULL,
  ...
  CONSTRAINT `ManufacturingOrder_has_Materials-Manufacturing`
    ...
    REFERENCES `phyzia3`.`ManufacturingOrder` (`ManufacturingOrder_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
