...
-- Schema killme
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `killme` DEFAULT CHARACTER SET utf8 ;
USE `killme` ;

-- -----------------------------------------------------
-- Table `killme`.`Employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Employee` (
...
-- -----------------------------------------------------
-- Table `killme`.`Customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Customer` (
...
-- -----------------------------------------------------
-- Table `killme`.`Opportunities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Opportunities` (
  ...
  CONSTRAINT `fk_opportunities_Customer1`
    ...
    REFERENCES `killme`.`Customer` (`Customer_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunities_Employee1`
    FOREIGN KEY (`Employee_Employee_ID`)
    REFERENCES `killme`.`Employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `killme`.`Customer_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Customer_Address` (
...
-- -----------------------------------------------------
-- Table `killme`.`Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Supplier` (
...
-- -----------------------------------------------------
-- Table `killme`.`Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Product` (
...
-- -----------------------------------------------------
-- Table `killme`.`Shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Shipment` (
...
-- -----------------------------------------------------
-- Table `killme`.`Payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Payment` (
...
-- -----------------------------------------------------
-- Table `killme`.`Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Category` (
...
-- -----------------------------------------------------
-- Table `killme`.`Product_has_Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Product_has_Supplier` (
...
-- -----------------------------------------------------
-- Table `killme`.`Product_has_Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Product_has_Category` (
  `Product_Product_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Product_has_Category1_Category1`
    ...
    REFERENCES `killme`.`Category` (`Category_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `killme`.`Account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Account` (
...
-- -----------------------------------------------------
-- Table `killme`.`Interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Interest` (
...
-- -----------------------------------------------------
-- Table `killme`.`Customer_Interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Customer_Interest` (
  `Level` INT NULL,
  `Customer_Customer_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Customer_Interest_Interest1`
    ...
    REFERENCES `killme`.`Interest` (`Interest_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `killme`.`Opportunity_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Opportunity_Product` (
  ...
  CONSTRAINT `fk_Opportunity_Product_Opportunities1`
    ...
    REFERENCES `killme`.`Opportunities` (`Opportunity_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `killme`.`order_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`order_table` (
  ...
  CONSTRAINT `fk_Order_Payment1`
    ...
    REFERENCES `killme`.`Payment` (`Payment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Order_Shipment1`
    ...
    REFERENCES `killme`.`Shipment` (`Shipment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `killme`.`Order_has_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Order_has_Product` (
  ...
  CONSTRAINT `fk_Order_has_Product1_Order1`
    ...
    REFERENCES `killme`.`order_table` (`Order_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `killme`.`Inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Inventory` (
...
-- -----------------------------------------------------
-- Table `killme`.`Inventory_has_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Inventory_has_Product` (
  ...
  CONSTRAINT `fk_Inventory_has_Product_Inventory1`
    ...
    REFERENCES `killme`.`Inventory` (`Inventory_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `killme`.`Employee_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Employee_Address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `killme`.`Supplier_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Supplier_Address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `killme`.`BillMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`BillMaterials` (
...
-- -----------------------------------------------------
-- Table `killme`.`Inventory_has_BillMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Inventory_has_BillMaterials` (
  `Inventory_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
  `position` VARCHAR(45) NULL,
  `Units_In_Inventory` INT NULL,
  ...
  CONSTRAINT `fk_Inventory_has_BillMaterials_BillMaterials`
    ...
    REFERENCES `killme`.`BillMaterials` (`BillMaterials_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `killme`.`Product_has_BillMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`Product_has_BillMaterials` (
  `Product_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `killme`.`ManufacturingOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`ManufacturingOrder` (
...
-- -----------------------------------------------------
-- Table `killme`.`ManufacturingOrder_has_Materials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killme`.`ManufacturingOrder_has_Materials` (
  `ManufacturingOrder_ID` VARCHAR(45) NOT NULL,
  `Product_ID` VARCHAR(45) NOT NULL,
  `Units_In_order` INT NULL,
  `Units_Done` INT NULL,
  ...
  CONSTRAINT `ManufacturingOrder_has_Materials-Manufacturing`
    ...
    REFERENCES `killme`.`ManufacturingOrder` (`ManufacturingOrder_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
