...
-- -----------------------------------------------------
-- Table `products`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`employee` (
...
-- -----------------------------------------------------
-- Table `products`.`opportunities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`opportunities` (
  ...
  CONSTRAINT `fk_opportunities_Customer1`
    ...
    REFERENCES `products`.`customer` (`Customer_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunities_Employee1`
    FOREIGN KEY (`Employee_Employee_ID`)
    REFERENCES `products`.`employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `products`.`customer_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`customer_address` (
...
-- -----------------------------------------------------
-- Table `products`.`supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`supplier` (
...
-- -----------------------------------------------------
-- Table `products`.`shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`shipment` (
...
-- -----------------------------------------------------
-- Table `products`.`payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`payment` (
...
-- -----------------------------------------------------
-- Table `products`.`product_has_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`product_has_category` (
...
-- -----------------------------------------------------
-- Table `products`.`interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`interest` (
...
-- -----------------------------------------------------
-- Table `products`.`customer_interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`customer_interest` (
  `Level` INT NULL,
  `Customer_Customer_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Customer_Interest_Interest1`
    ...
    REFERENCES `products`.`interest` (`Interest_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `products`.`opportunity_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`opportunity_product` (
  ...
  CONSTRAINT `fk_Opportunity_Product_Opportunities1`
    ...
    REFERENCES `products`.`opportunities` (`Opportunity_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `products`.`order_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`order_table` (
...
-- -----------------------------------------------------
-- Table `products`.`order_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`order_has_product` (
  `Product_Product_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Order_has_Product_Inventory1`
    ...
    REFERENCES `products`.`inventory` (`Inventory_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Order_has_Product_order_table1`
    FOREIGN KEY (`order_table_Order_ID`)
    REFERENCES `products`.`order_table` (`Order_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `products`.`inventory_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`inventory_has_product` (
...
-- -----------------------------------------------------
-- Table `products`.`employee_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`employee_address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `products`.`supplier_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`supplier_address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `products`.`billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`billMaterials` (
...
-- -----------------------------------------------------
-- Table `products`.`inventory_has_billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`inventory_has_billMaterials` (
  `Inventory_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
  `position` VARCHAR(45) NULL,
  `Units_In_Inventory` INT NULL,
  ...
  CONSTRAINT `fk_Inventory_has_BillMaterials_BillMaterials`
    ...
    REFERENCES `products`.`billMaterials` (`BillMaterials_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `products`.`product_has_billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`product_has_billMaterials` (
  `Product_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `products`.`manufacturingOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`manufacturingOrder` (
...
-- -----------------------------------------------------
-- Table `products`.`manufacturingOrder_has_materials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`manufacturingOrder_has_materials` (
  `ManufacturingOrder_ID` VARCHAR(45) NOT NULL,
  `Product_ID` VARCHAR(45) NOT NULL,
  `Units_In_order` INT NULL,
  `Units_Done` INT NULL,
  ...
  CONSTRAINT `ManufacturingOrder_has_Materials-Manufacturing`
    ...
    REFERENCES `products`.`manufacturingOrder` (`ManufacturingOrder_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `products`.`product_has_supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`product_has_supplier` (
  `product_Product_ID` VARCHAR(45) NOT NULL,
  `supplier_Supplier_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `products`.`customer_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `products`.`customer_copy1` (
  `Customer_ID` VARCHAR(45) NOT NULL,
  `Customer_Name` VARCHAR(45) NULL,
  `Customer_Phone_Number` DECIMAL NULL,
  `Customer_Email` VARCHAR(100) NULL,
