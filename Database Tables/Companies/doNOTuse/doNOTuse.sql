...
-- Schema doNOTuse
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `doNOTuse` DEFAULT CHARACTER SET utf8 ;
USE `doNOTuse` ;

-- -----------------------------------------------------
-- Table `doNOTuse`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`employee` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`customer` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`opportunities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`opportunities` (
  ...
  CONSTRAINT `fk_opportunities_Customer1`
    ...
    REFERENCES `doNOTuse`.`customer` (`Customer_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunities_Employee1`
    FOREIGN KEY (`Employee_Employee_ID`)
    REFERENCES `doNOTuse`.`employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`customer_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`customer_address` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`supplier` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`product` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`shipment` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`payment` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`category` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`account` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`product_has_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`product_has_category` (
  ...
  CONSTRAINT `fk_Product_has_Category1_Product1`
    ...
    REFERENCES `doNOTuse`.`product` (`Product_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Product_has_Category1_Category1`
    FOREIGN KEY (`Category_Category_ID`)
    REFERENCES `doNOTuse`.`category` (`Category_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`interest` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`customer_interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`customer_interest` (
  `Level` INT NULL,
  `Customer_Customer_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Customer_Interest_Interest1`
    ...
    REFERENCES `doNOTuse`.`interest` (`Interest_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`opportunity_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`opportunity_product` (
  ...
  CONSTRAINT `fk_Opportunity_Product_Opportunities1`
    ...
    REFERENCES `doNOTuse`.`opportunities` (`Opportunity_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`order_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`order_table` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`inventory` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`order_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`order_has_product` (
  `Product_Product_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Order_has_Product_Inventory1`
    ...
    REFERENCES `doNOTuse`.`inventory` (`Inventory_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Order_has_Product_order_table1`
    FOREIGN KEY (`order_table_Order_ID`)
    REFERENCES `doNOTuse`.`order_table` (`Order_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`inventory_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`inventory_has_product` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`employee_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`employee_address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`supplier_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`supplier_address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`billMaterials` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`inventory_has_billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`inventory_has_billMaterials` (
  `Inventory_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
  `position` VARCHAR(45) NULL,
  `Units_In_Inventory` INT NULL,
  ...
  CONSTRAINT `fk_Inventory_has_BillMaterials_BillMaterials`
    ...
    REFERENCES `doNOTuse`.`billMaterials` (`BillMaterials_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`product_has_billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`product_has_billMaterials` (
  `Product_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`manufacturingOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`manufacturingOrder` (
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`manufacturingOrder_has_materials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`manufacturingOrder_has_materials` (
  `ManufacturingOrder_ID` VARCHAR(45) NOT NULL,
  `Product_ID` VARCHAR(45) NOT NULL,
  `Units_In_order` INT NULL,
  `Units_Done` INT NULL,
  ...
  CONSTRAINT `ManufacturingOrder_has_Materials-Manufacturing`
    ...
    REFERENCES `doNOTuse`.`manufacturingOrder` (`ManufacturingOrder_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`product_has_supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`product_has_supplier` (
  `product_Product_ID` VARCHAR(45) NOT NULL,
  `supplier_Supplier_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `doNOTuse`.`customer_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `doNOTuse`.`customer_copy1` (
  `Customer_ID` VARCHAR(45) NOT NULL,
  `Customer_Name` VARCHAR(45) NULL,
  `Customer_Phone_Number` DECIMAL NULL,
  `Customer_Email` VARCHAR(100) NULL,
