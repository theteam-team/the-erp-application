...
-- Schema enough
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `enough` DEFAULT CHARACTER SET utf8 ;
USE `enough` ;

-- -----------------------------------------------------
-- Table `enough`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`employee` (
...
-- -----------------------------------------------------
-- Table `enough`.`customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`customer` (
...
-- -----------------------------------------------------
-- Table `enough`.`opportunities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`opportunities` (
  ...
  CONSTRAINT `fk_opportunities_Customer1`
    ...
    REFERENCES `enough`.`customer` (`Customer_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunities_Employee1`
    FOREIGN KEY (`Employee_Employee_ID`)
    REFERENCES `enough`.`employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `enough`.`customer_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`customer_address` (
...
-- -----------------------------------------------------
-- Table `enough`.`supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`supplier` (
...
-- -----------------------------------------------------
-- Table `enough`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`product` (
...
-- -----------------------------------------------------
-- Table `enough`.`shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`shipment` (
...
-- -----------------------------------------------------
-- Table `enough`.`payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`payment` (
...
-- -----------------------------------------------------
-- Table `enough`.`category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`category` (
...
-- -----------------------------------------------------
-- Table `enough`.`account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`account` (
...
-- -----------------------------------------------------
-- Table `enough`.`product_has_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`product_has_category` (
  ...
  CONSTRAINT `fk_Product_has_Category1_Product1`
    ...
    REFERENCES `enough`.`product` (`Product_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Product_has_Category1_Category1`
    FOREIGN KEY (`Category_Category_ID`)
    REFERENCES `enough`.`category` (`Category_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `enough`.`interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`interest` (
...
-- -----------------------------------------------------
-- Table `enough`.`customer_interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`customer_interest` (
  `Level` INT NULL,
  `Customer_Customer_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Customer_Interest_Interest1`
    ...
    REFERENCES `enough`.`interest` (`Interest_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `enough`.`opportunity_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`opportunity_product` (
  ...
  CONSTRAINT `fk_Opportunity_Product_Opportunities1`
    ...
    REFERENCES `enough`.`opportunities` (`Opportunity_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `enough`.`order_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`order_table` (
...
-- -----------------------------------------------------
-- Table `enough`.`inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`inventory` (
...
-- -----------------------------------------------------
-- Table `enough`.`order_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`order_has_product` (
  `Product_Product_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Order_has_Product_Inventory1`
    ...
    REFERENCES `enough`.`inventory` (`Inventory_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Order_has_Product_order_table1`
    FOREIGN KEY (`order_table_Order_ID`)
    REFERENCES `enough`.`order_table` (`Order_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `enough`.`inventory_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`inventory_has_product` (
...
-- -----------------------------------------------------
-- Table `enough`.`employee_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`employee_address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `enough`.`supplier_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`supplier_address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `enough`.`billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`billMaterials` (
...
-- -----------------------------------------------------
-- Table `enough`.`inventory_has_billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`inventory_has_billMaterials` (
  `Inventory_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
  `position` VARCHAR(45) NULL,
  `Units_In_Inventory` INT NULL,
  ...
  CONSTRAINT `fk_Inventory_has_BillMaterials_BillMaterials`
    ...
    REFERENCES `enough`.`billMaterials` (`BillMaterials_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `enough`.`product_has_billMaterials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`product_has_billMaterials` (
  `Product_ID` VARCHAR(45) NOT NULL,
  `BillMaterials_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `enough`.`manufacturingOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`manufacturingOrder` (
...
-- -----------------------------------------------------
-- Table `enough`.`manufacturingOrder_has_materials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`manufacturingOrder_has_materials` (
  `ManufacturingOrder_ID` VARCHAR(45) NOT NULL,
  `Product_ID` VARCHAR(45) NOT NULL,
  `Units_In_order` INT NULL,
  `Units_Done` INT NULL,
  ...
  CONSTRAINT `ManufacturingOrder_has_Materials-Manufacturing`
    ...
    REFERENCES `enough`.`manufacturingOrder` (`ManufacturingOrder_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `enough`.`product_has_supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`product_has_supplier` (
  `product_Product_ID` VARCHAR(45) NOT NULL,
  `supplier_Supplier_ID` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `enough`.`customer_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enough`.`customer_copy1` (
  `Customer_ID` VARCHAR(45) NOT NULL,
  `Customer_Name` VARCHAR(45) NULL,
  `Customer_Phone_Number` DECIMAL NULL,
  `Customer_Email` VARCHAR(100) NULL,
