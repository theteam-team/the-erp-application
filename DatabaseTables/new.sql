...
-- Table `new`.`Employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Employee` (
...
-- Table `new`.`Customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Customer` (
...
-- -----------------------------------------------------
-- Table `new`.`Opportunities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Opportunities` (
  ...
  CONSTRAINT `fk_opportunities_Customer1`
    ...
    REFERENCES `new`.`Customer` (`Customer_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunities_Employee1`
    FOREIGN KEY (`Employee_Employee_ID`)
    REFERENCES `new`.`Employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `new`.`Customer_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Customer_Address` (
...
-- Table `new`.`Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Supplier` (
...
-- Table `new`.`Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Product` (
...
-- Table `new`.`Shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Shipment` (
...
-- Table `new`.`Payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Payment` (
...
-- Table `new`.`Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Category` (
...
-- -----------------------------------------------------
-- Table `new`.`Product_has_Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Product_has_Supplier` (
...
-- -----------------------------------------------------
-- Table `new`.`Product_has_Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Product_has_Category` (
  `Product_Product_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Product_has_Category1_Category1`
    ...
    REFERENCES `new`.`Category` (`Category_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `new`.`Order_has_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Order_has_Product` (
...
-- Table `new`.`Account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Account` (
...
-- Table `new`.`Interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Interest` (
...
-- -----------------------------------------------------
-- Table `new`.`Customer_Interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Customer_Interest` (
  `Level` INT NULL,
  `Customer_Customer_ID` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_Customer_Interest_Interest1`
    ...
    REFERENCES `new`.`Interest` (`Interest_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `new`.`Opportunity_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Opportunity_Product` (
  ...
  CONSTRAINT `fk_Opportunity_Product_Opportunities1`
    ...
    REFERENCES `new`.`Opportunities` (`Opportunity_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `new`.`Order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Order` (
  ...
  CONSTRAINT `fk_Order_Payment1`
    ...
    REFERENCES `new`.`Payment` (`Payment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Order_Shipment1`
    ...
    REFERENCES `new`.`Shipment` (`Shipment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `new`.`Inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Inventory` (
...
-- -----------------------------------------------------
-- Table `new`.`Inventory_has_Product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Inventory_has_Product` (
  ...
  CONSTRAINT `fk_Inventory_has_Product_Inventory1`
    ...
    REFERENCES `new`.`Inventory` (`Inventory_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `new`.`Employee_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Employee_Address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `new`.`Supplier_Address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Supplier_Address` (
  `Address_ID` VARCHAR(45) NOT NULL,
  `City` VARCHAR(45) NULL,
  `Governate` VARCHAR(45) NULL,
  `Street` VARCHAR(45) NULL,
